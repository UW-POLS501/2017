...
# Data Analysis 1: Data Availability
...
- How do the variables in your dataset relate to the variables in your theory? In other words, how are you operationalizing your concepts? Justify that operationalization, and acknowledge any shortcomings of it.
...
# Data Analysis 3: Regression and Prediction

*DRAFT*

Addressing threats to validity through (1) careful subsetting, or (2) linear regression, or a design based strategy.


# Data Analysis 4: Hypothesis Testing

*DRAFT*

Addressing uncertainty: confidence intervals, hypothesis testing, and cross-validation.
